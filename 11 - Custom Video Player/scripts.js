...
progress.addEventListener("mousemove", (e) => mousedownCheck && scrub(e));
progress.addEventListener("mousedown", () => mousedownCheck = true);
progress.addEventListener("mouseup", () => mousedownCheck = false);